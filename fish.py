...
class Fish:
    def __init__(self):
        ...
        self.images = [image.load("Assets/fish/fish.png", size=size, flip=moving_direction=="right")]
        self.current_frame = 0
        self.animation_timer = 0


    def define_spawn_pos(self, size): # define the start pos and moving vel of the fish
        vel = random.uniform(FISH_MOVE_SPEED["min"], FISH_MOVE_SPEED["max"])
